...
proc create_root_design { parentCell } {
  ...
  set PMU_IIC [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 PMU_IIC ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports PMU_IIC] [get_bd_intf_pins axi_iic_0/IIC]
  ...
  # Create port connections
  connect_bd_net -net btn0_1 [get_bd_ports btn0] [get_bd_pins util_vector_logic_0/Op1]
